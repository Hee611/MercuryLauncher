            ...
            <div class="settingsAuthAccountRight">
                <div class="settingsAuthAccountDetails">
                    <div class="settingsAuthAccountDetailPane">
                        <div class="settingsAuthAccountDetailTitle">유저이름</div>
...
function populateJavaExecDetails(execPath){
    ...
    jg._validateJavaBinary(execPath).then(v => {
        if(v.valid){
            ...
            settingsJavaExecDetails.innerHTML = '올바른 실행이 가능한 Java 런타임이 없습니다.'
        }
    })
}
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('GitHub에서 다운로드<span style="font-size: 10px;color: gray;text-shadow: none !important;">런처를 닫고, .dmg 파일을 실행하여 업데이트를 진행해 주세요.</span>', false, () => {
